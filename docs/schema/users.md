...
| ---- | ---- | ------- | -------- | ---------------- | -------- | ------- | ------- |
| id | bigint unsigned |  | false | auto_increment | [user_diagnose_results](user_diagnose_results.md) [user_visited_stores](user_visited_stores.md) |  |  |
...
| Name | Definition |
| ---- | ---------- |
| users_provider_provider_id_index | KEY users_provider_provider_id_index (provider, provider_id) USING BTREE |
